...
import { Bell, Play, Info } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { getVocalGameConfig } from "@/config/vocalGames";

function VocalGameStartContent() {
  ...
  useEffect(() => {
    ...
    const config = getVocalGameConfig(gameId);
    if (!config) {
      router.push("/learning/vocal");
      return;
    }
  ...
  const proceedToGame = () => {
    ...
    sessionStorage.setItem("vocal_game_difficulty", difficulty.toString());
    sessionStorage.setItem("vocal_game_duration", timeDuration.toString());
    sessionStorage.setItem("vocal_game_id", gameConfig.id);
...
export default function VocalGameStartPage() {
  return (
    <Suspense fallback={
